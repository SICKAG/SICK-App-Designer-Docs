...
* Optional: https://www.sick.com/br/en/catalog/products/digital-services-and-software/engineering-tools/sick-creator/c/g622676[*SICK Sentio Creator*]
...
* *SICK programmable device*, e.g. InspectorP or SIM2000:
...
8. After the device connectivity installation is complete, the last step is to accept the terms and conditions in the consent dialog that appears on the first run of the extension.
