...
//pages
|pages/|*|This folder contains the UI definition of an application, see link:https://github.com/SICKAG/SICK-App-Designer-Docs/tree/master/Documentation%20and%20Tutorials/UIBuilder%20Tutorials[UI-Builder documentation] for more details.
...
For Flow files there is also an additional xref:../../Chapter_4-Misc/4.1-Commands/Commands.adoc[command] to create a new flow using a visual dialog: `SICK App Designer: New Flow`
...
Search for `SICK App Designer: Upload` to find the available commands.
