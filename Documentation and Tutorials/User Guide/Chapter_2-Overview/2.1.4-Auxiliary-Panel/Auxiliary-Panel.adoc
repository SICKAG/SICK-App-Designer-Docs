...
To access the Device Console, either manually select `SICK App Designer Device Console` from the dropdown menu of the _OUTPUT_ Tab, use the xref:../../Chapter_4-Misc/4.1-Commands/Commands.adoc[command] `SICK App Designer: Show device console` or use the device console button on the xref:../2.1.7-Device-List/Device-List.adoc[device list].
...
To access the Device Monitor, either manually select the _DEVICE MONITOR_ tab in the Auxiliary Panel or execute the xref:../../Chapter_4-Misc/4.1-Commands/Commands.adoc[command] `Device Monitor: Focus on Device Monitor View`.
